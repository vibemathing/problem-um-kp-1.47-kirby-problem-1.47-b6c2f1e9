...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.47"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-v1",
      "problem_contract_sha256": "b7075cd82ac2d9729bddc4c29eb9f4d60787b0c2e6a7477307ca59862e682d30",
      "problem_id": "problem:um-kp-1.47-kirby-problem-1.47-b6c2f1e9",
      "route_id": "route:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-source-fidelity-01",
      "graph_id": "graph:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Given a smooth knot $K \\subset S^{3}$, determine its nonorientable 4- genus $\\gamma_{4}$, i.e. the minimal first Betti number for all compact nonorientable smooth surfaces $F$ properly embedded in $B^{4}$ with boundary $K$. This question may be devel- oped in several directions: (1) (Allen’s Geography Question [All23]) For a given knot $K \\subset S^{3}$, find the pairs $(e, b) \\in \\mathbb{Z}^{2}$ realized by the normal Euler number and first Betti number of a nonorientable bounding surface $F$. (2) By analogy with the Milnor Conjecture for the orientable 4-genus of torus knots, what is the nonorientable 4-genus of a torus knot $T_{p,q}$?"
          },
          "statement_sha256": "8f8655abc5d9972bb9ae356a30ff6647f120f7f7adcfc4e673c05977dcecd23d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-root",
      "route_id": "route:um-kp-1.47-kirby-problem-1.47-b6c2f1e9-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.47-2ad48071b3d3",
        "url": "https://www.unsolvedmath.com/problems/KP-1.47"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
